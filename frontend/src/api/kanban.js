...
// Add column to board
export async function createColumn(organizationId, boardId, username, title, position = 0) {
...
export async function updateColumnPosition(organizationId, boardId, columnId, username, position) {
  if (!organizationId || !boardId || !columnId || !username || position === undefined) {
    throw new Error('organizationId, boardId, columnId, username and position are required')
  }
...
export async function updateColumn(organizationId, boardId, columnId, username, updates) {
  if (!organizationId || !boardId || !columnId || !username) {
    throw new Error('organizationId, boardId, columnId and username are required')
  }
...
// Delete column
export async function deleteColumn(organizationId, boardId, columnId, userId) {
  if (!organizationId || !boardId || !columnId || !userId) {
    throw new Error('organizationId, boardId, columnId and userId are required')
  }
...
// Create task
export async function createTask(organizationId, boardId, columnId, username, taskData) {
  if (!organizationId || !boardId || !columnId || !username) {
    throw new Error('organizationId, boardId, columnId and username are required')
  }
...
// Update task
export async function updateTask(organizationId, boardId, columnId, taskId, username, taskData) {
  if (!organizationId || !boardId || !columnId || !taskId || !username) {
    throw new Error('organizationId, boardId, columnId, taskId and username are required')
  }
...
// Delete task
export async function deleteTask(organizationId, boardId, columnId, taskId, username) {
  if (!organizationId || !boardId || !columnId || !taskId || !username) {
    throw new Error('organizationId, boardId, columnId, taskId and username are required')
  }
