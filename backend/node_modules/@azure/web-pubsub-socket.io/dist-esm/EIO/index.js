...
export class WebPubSubEioServer extends engine.Server {
    ...
    async onConnect(connectionId, connectReq, context) {
        await this.handshake(WEBPUBSUB_TRANSPORT_NAME, connectReq, (errorCode, errorContext) => {
            const message = errorContext && errorContext["message"] ? errorContext["message"] : EIO_CONNECTION_ERROR[errorCode];
    ...
    async onUserEvent(connectionId, content) {
        ...
        for (const packet of packets) {
            ...
            client.transport.emit("packet", packet);
        }
    }
