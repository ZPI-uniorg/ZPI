...
urlpatterns = [
    path("boards/", get_kanban_boards, name="get_kanban_boards"),
    ...
    path(
        "boards/update/<int:board_id>/", update_kanban_board, name="update_kanban_board"
    ),
    path(
        "boards/delete/<int:board_id>/", delete_kanban_board, name="delete_kanban_board"
    ),
